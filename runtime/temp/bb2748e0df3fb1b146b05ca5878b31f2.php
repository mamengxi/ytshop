<?php /*a:2:{s:61:"/home/wwwroot/ytshop/application/admin/view/product/kind.html";i:1523434691;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-lg-12">
                ...
                <div class="search-box form-group col-sm-12">
                    <form role="form" class="form-inline layui-form" method="get">
                        <div class="input-group">
                            ...
                            <input type="text" name="title" placeholder="请输入种类" class="form-control j-data" value="<?php echo htmlentities((isset($_GET['title']) && ($_GET['title'] !== '')?$_GET['title']:'')); ?>">
                        </div>
                        ...
                        <a class="btn btn-primary" href="<?php echo url('Product/kind'); ?>" >清空</a>
                    </form>
                </div>
            </div>
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr class="gradeX">
                    ...
                    <td class="layui-form"><input type="checkbox" <?php if($vo['status'] == 1): ?>checked=""<?php endif; ?> data-db="kind" data-id="<?php echo htmlentities($vo['id']); ?>" name="open" lay-skin="switch" lay-filter="switchStatus" lay-text="ON|OFF"></td>
                    <td>
                        <button class="btn btn-xs btn-default do-del" data-db="kind" data-id="<?php echo htmlentities($vo['id']); ?>" data-status="-1"><i class="fa fa-trash-o"></i> 删除</button>
                        <a class="btn btn-xs btn-primary" onclick="layer_show('编辑种类','/admin/Product/kind_edit?id=<?php echo htmlentities($vo['id']); ?>',1000)"><i class="fa fa-edit"></i> 编辑</a>
                    </td>
                </tr>
