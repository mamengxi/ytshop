<?php /*a:2:{s:60:"/home/wwwroot/ytshop/application/admin/view/index/index.html";i:1524880330;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        <table class="layui-table" lay-data="{height:'auto', url:'/admin/index/index/', page:true, id:'test',method: 'post'}" lay-filter="test">
            <thead>
            <tr>
                <th lay-data="{field:'action_ip', width:180}">ip</th>
                <th lay-data="{field:'remark'}">操作</th>
                <th lay-data="{field:'create_time'}">操作时间</th>
            </tr>
            </thead>
        </table>
        <table class="layui-table" lay-even>
             ...
             <tbody>
                 ...
                 <tr>
                     <td><?php echo htmlentities($vo['action_ip']); ?></td>
