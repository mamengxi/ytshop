<?php /*a:2:{s:62:"/home/wwwroot/ytshop/application/admin/view/contact/index.html";i:1523434689;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-lg-12">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr class="gradeX">
                    ...
                    <td><?php echo htmlentities($vo['mess']); ?></td>
                    <td>
                        <button class="btn btn-xs btn-default do-del" data-db="contact_us" data-id="<?php echo htmlentities($vo['id']); ?>" data-status="-1"><i class="fa fa-trash-o"></i> 删除</button>
                    </td>
                </tr>
