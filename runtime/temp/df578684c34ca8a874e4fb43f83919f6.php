<?php /*a:2:{s:68:"/home/wwwroot/ytshop/application/admin/view/operate/ad_location.html";i:1525944714;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="form-group">
                <!--<button class="btn btn-sm btn-primary m-t-n-xs" onclick="layer_show('添加广告位','/admin/Operate/ad_location_add.html',800,365)"><strong>添加广告位</strong></button>-->
                 <!--<button class="btn btn-sm btn-primary m-t-n-xs do-del-all" data-db="ad_location" data-status="1"><strong>启用</strong></button>-->
                 <!--<button class="btn btn-sm btn-primary m-t-n-xs do-del-all" data-db="ad_location" data-status="0"><strong>禁用</strong></button>-->
            </div>
            <table class="table table-bordered table-hover">
                ...
                <tr class="gradeX">
                    ...
                    <td><?php echo htmlentities($vo['location']); ?></td>
                     <!--<td class="layui-form"><input type="checkbox" <?php if($vo['status'] == 1): ?>checked=""<?php endif; ?> data-db="ad_location" data-id="<?php echo htmlentities($vo['id']); ?>" name="open" lay-skin="switch" lay-filter="switchStatus" lay-text="ON|OFF"></td>-->
                    <td>
                        <button class="btn btn-xs btn-mint" onclick="layer_show('广告管理','/admin/Operate/ad.html?location_id=<?php echo htmlentities($vo['id']); ?>',1000)"><i class="fa fa-sliders"></i> 广告管理</button>
                        <button class="btn btn-xs btn-primary" onclick="layer_show('编辑广告位','/admin/Operate/ad_location_edit.html?id=<?php echo htmlentities($vo['id']); ?>',800,365)"><i class="fa fa-edit"></i> 编辑</button>
                        <!--<button class="btn btn-xs btn-default do-del" data-db="ad_location" data-id="<?php echo htmlentities($vo['id']); ?>" data-status="-1"><i class="fa fa-trash-o"></i> 删除</button>-->
                    </td>
                </tr>
