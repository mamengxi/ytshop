<?php /*a:2:{s:69:"/home/wwwroot/ytshop/application/admin/view/product/product_list.html";i:1523434691;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-lg-12">
                ...
                <div class="search-box form-group col-sm-12">
                    <form role="form" class="form-inline layui-form" method="get">
                        <div class="input-group">
                            ...
                            <input type="text" name="title" placeholder="请输入产品名称" class="form-control j-data" value="<?php echo htmlentities((isset($_GET['title']) && ($_GET['title'] !== '')?$_GET['title']:'')); ?>">
                        ...
                        <a class="btn btn-primary" href="<?php echo url('Product/product_list'); ?>" >清空</a>
                    </form>
                </div>
            </div>
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr class="gradeX">
                    ...
                    <td><?php echo htmlentities($vo['ktitle']); ?></td>
                    ...
                    <td>
                        <a class="btn btn-xs btn-primary" onclick="layer_show('编辑产品','/admin/Product/product_edit?id=<?php echo htmlentities($vo['id']); ?>',1200)"><i class="fa fa-edit"></i> 编辑</a>
                        <button class="btn btn-xs btn-default do-del" data-db="product" data-id="<?php echo htmlentities($vo['id']); ?>" data-status="-1"><i class="fa fa-trash"></i>删除</button>
                    </td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
