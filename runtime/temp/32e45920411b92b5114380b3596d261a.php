<?php /*a:2:{s:65:"/home/wwwroot/ytshop/application/admin/view/goods/goods_list.html";i:1523434690;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                <div class="form-group col-sm-12">
                    <a class="btn btn-sm btn-primary" onclick="layer_show('添加商品','/admin/Goods/goods_add',1000)">添加商品</a>
                ...
                <div class="search-box form-group col-sm-12">
                    <form role="form" class="form-inline layui-form" method="get">
                        ...
                        <a class="btn btn-primary" href="<?php echo url('Goods/goods_list'); ?>" >清空</a>
                    </form>
                </div>
            </div>
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr class="gradeX">
                    ...
                    <td><?php echo htmlentities((isset($vo['title']) && ($vo['title'] !== '')?$vo['title']:"-")); ?> <span style="color: #999999;">(id:<?php echo htmlentities($vo['id']); ?>)</span></td>
                    ...
                    <td class="layui-form"><input type="checkbox" <?php if($vo['status'] == 1): ?>checked=""<?php endif; ?> data-db="goods" data-id="<?php echo htmlentities($vo['id']); ?>" name="open" lay-skin="switch" lay-filter="switchStatus" lay-text="上架|下架"></td>
                    <td>
                        <button class="btn btn-xs btn-mint" onclick="layer_show('单品管理','/admin/Goods/item.html?location_id=<?php echo htmlentities($vo['id']); ?>',1000)"><i class="fa fa-sliders"></i> 单品管理</button>
                        <a class="btn btn-xs btn-primary" onclick="layer_show('编辑商品','/admin/Goods/goods_edit?id=<?php echo htmlentities($vo['id']); ?>',1000)"><i class="fa fa-edit"></i> 编辑</a>
                        <button class="btn btn-xs btn-default do-del" data-db="goods" data-id="<?php echo htmlentities($vo['id']); ?>" data-status="-1"><i class="fa fa-trash"></i>删除</button>
                    </td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
