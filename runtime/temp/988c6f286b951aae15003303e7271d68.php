<?php /*a:2:{s:65:"/home/wwwroot/ytshop/application/admin/view/order/goods_send.html";i:1523434691;s:62:"/home/wwwroot/ytshop/application/admin/view/public/iframe.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                ...
                <form class="layui-form form-horizontal" action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                            ...
                            <div class="input-group">
                                <div class="search-box form-group" style="width: 100px;margin-left: 16px;" >
                                    <select name="shipper_code">
                                        ...
                                        <option value="<?php echo htmlentities($vo['shipper_code']); ?>" <?php if($vo['shipper_code'] == $express_company): ?>selected=""<?php endif; ?>><?php echo htmlentities($vo['express_company']); ?></option>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">快递单号</label>
                            <div class="col-sm-3">
                                <input type="text" name="logistics_code" lay-verify="required" autocomplete="off" placeholder="请输入快递单号"  class="form-control">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-10 col-sm-offset-2">
                                <button class="btn btn-mint" lay-submit="" data-url="<?php echo url('Order/goods_send'); ?>" lay-filter="submit">提交</button>
