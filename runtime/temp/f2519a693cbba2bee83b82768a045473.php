<?php /*a:2:{s:64:"/home/wwwroot/ytshop/application/admin/view/goods/item_edit.html";i:1524706670;s:62:"/home/wwwroot/ytshop/application/admin/view/public/iframe.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
        ...
        <div class="layui-tab">
            <div class="layui-tab-content">
                <form class="layui-form form-horizontal" action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <?php if(is_array($attr) || $attr instanceof \think\Collection || $attr instanceof \think\Paginator): $index = 0; $__LIST__ = $attr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($index % 2 );++$index;?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <?php if(is_array($v['attr_value']) || $v['attr_value'] instanceof \think\Collection || $v['attr_value'] instanceof \think\Paginator): $i = 0; $__LIST__ = $v['attr_value'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        ...
                                        <input type="radio" name="name[<?php echo htmlentities($v['id']); ?>]" value="<?php echo htmlentities($vo['good_attr_id']); ?>" title="<?php echo htmlentities($vo['attr_name']); ?>" <?php if($info['attr_id'][$index-1] == $vo['good_attr_id']): ?>checked<?php endif; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="price" value="<?php echo htmlentities($info['price']/100); ?>" lay-verify="required" autocomplete="off" placeholder="请输入商品价格" class="form-control" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">库存</label>
                            <div class="col-sm-6">
                                <input type="text" name="stock" value="<?php echo htmlentities($info['stock']); ?>" lay-verify="required" autocomplete="off" placeholder="请输入商品库存" class="form-control" >
                            </div>
                        </div>
