<?php /*a:2:{s:63:"/home/wwwroot/ytshop/application/admin/view/goods/comments.html";i:1523434690;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <div class="search-box col-sm-9">
                    <form role="form" class="form-inline" method="get">
                        <div class="input-group">
                            <div class="input-group-btn">
                                <button class="btn btn-default j-text" type="button">
                                    <?php if(input('title',0)): ?>
                                    商品
                                    <?php elseif(input('nickname',0)): ?>
                                    用户昵称
                                    <?php else: ?>
                                    商品
                                    <?php endif; ?>
                            ...
                            <input type="text" name="title" placeholder="请输入商品" class="form-control j-data" value="<?php echo htmlentities((isset($_GET['title']) && ($_GET['title'] !== '')?$_GET['title']:'')); ?><?php echo htmlentities((isset($_GET['nickname']) && ($_GET['nickname'] !== '')?$_GET['nickname']:'')); ?>">
                        </div>
                        ...
                        <a class="btn btn-primary" href="<?php echo url('Goods/comments'); ?>" >清空</a>
                    </form>
                </div>
            </div>
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr class="gradeX">
                    ...
                    <td class="c-primary"><?php echo htmlentities($vo['title']); ?></td>
                    ...
                    <td>
                        <button class="btn btn-xs btn-default do-del" data-db="comments" data-id="<?php echo htmlentities($vo['id']); ?>" data-status="0"><i class="fa fa-trash-o"></i> 删除</button>
                        <a class="btn btn-xs btn-primary" onclick="layer_show('评论详情','/admin/Goods/comments_detail?id=<?php echo htmlentities($vo['id']); ?>',1000)"><i class="fa fa-datail"></i> 详情</a>
                    </td>
                </tr>
