<?php /*a:2:{s:59:"/home/wwwroot/ytshop/application/admin/view/user/index.html";i:1526010696;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-lg-12">
                ...
                <div class="search-box form-group col-sm-12">
                    <form role="form" class="form-inline layui-form" method="get">
                        <div class="input-group">
                            ...
                            <input type="text" name="phone" placeholder="请输入手机号" class="form-control j-data" value="<?php echo htmlentities((isset($_GET['username']) && ($_GET['username'] !== '')?$_GET['username']:'')); ?><?php echo htmlentities((isset($_GET['phone']) && ($_GET['phone'] !== '')?$_GET['phone']:'')); ?>">
                        ...
                        <a class="btn btn-primary" href="<?php echo url('User/index'); ?>" >清空</a>
                    </form>
                </div>
            </div>
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr class="gradeX">
                    ...
                    <td class="c-primary"><?php echo htmlentities($vo['nickname']); ?></td>
                    <td><?php echo htmlentities((isset($vo['real_name']) && ($vo['real_name'] !== '')?$vo['real_name']:"-")); ?></td>
                    <td><?php echo htmlentities($vo['phone']); ?></td>
                    <td>
                        <?php switch($vo['sex']): case "1": ?>男<?php break; case "2": ?>女<?php break; default: ?>保密
                        <?php endswitch; ?>
                    </td>
                    <td><?php echo htmlentities($vo['id_card']); ?></td>
                    ...
                    <td><?php switch($vo['identify']): case "1": ?><span style="color: #00FF00">已审核通过</span><?php break; case "2": ?><span style="color: #FF0000">未审核通过</span><?php break; case "3": ?><span style="color: #FF9900">审核申请中</span><?php break; case "4": ?><span style="color: #CCCCCC">未申请审核</span><?php break; endswitch; ?>
                    </td>
                    <td>
                        <?php switch($vo['identify']): case "3": ?>
                        <a class="btn btn-xs btn-danger" onclick="layer_show('身份审核','/admin/User/user_identify?id=<?php echo htmlentities($vo['id']); ?>',800,600)">身份审核</a>
                        <?php break; endswitch; ?>
                        <a class="btn btn-xs btn-primary" onclick="layer_show('用户详情','/admin/User/user_edit?id=<?php echo htmlentities($vo['id']); ?>',1000)"><i class="fa fa-edit"></i>详情</a>
                        <!--<button class="btn btn-xs btn-default do-del" data-db="user" data-id="<?php echo htmlentities($vo['id']); ?>" data-status="-1"><i class="fa fa-trash-o"></i> 删除</button>-->
                    </td>
                </tr>
