<?php /*a:2:{s:64:"/home/wwwroot/ytshop/application/admin/view/auth/admin_edit.html";i:1523434689;s:62:"/home/wwwroot/ytshop/application/admin/view/public/iframe.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                ...
                <form class="layui-form form-horizontal" action="">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <span class="form-control"><?php echo htmlentities($info['username']); ?></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">角色</label>
                            <div class="col-sm-9">
                                <input type="text" name="rolename" lay-verify="required" value="<?php echo htmlentities($info['rolename']); ?>" autocomplete="off" placeholder="请输入角色名" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">密码</label>
                            <div class="col-sm-9">
                                <input type="password" name="password" lay-verify="required" value="<?php echo htmlentities($info['password']); ?>" autocomplete="off" placeholder="请输入密码" class="form-control" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">电话</label>
                            <div class="col-sm-9">
                                <input type="text" name="tel" placeholder="请输入电话" value="<?php echo htmlentities($info['tel']); ?>" autocomplete="off" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">邮箱</label>
                            <div class="col-sm-9">
                                <input type="text" name="email" placeholder="请输入邮箱" value="<?php echo htmlentities($info['email']); ?>" autocomplete="off" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-9 col-sm-offset-3">
                                <button class="btn btn-mint" lay-submit="" data-url="/admin/Auth/admin_edit?id=<?php echo htmlentities($info['id']); ?>" lay-filter="submit">提交</button>
