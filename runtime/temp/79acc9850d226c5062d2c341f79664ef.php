<?php /*a:2:{s:58:"/home/wwwroot/ytshop/application/admin/view/auth/rule.html";i:1523434689;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="table-responsive layui-table">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><?php echo htmlentities($vo['html']); ?><?php echo htmlentities($vo['title']); ?></td>
                    <td><?php echo htmlentities($vo['url']); ?></td>
                    <td><?php echo htmlentities($vo['pid']); ?></td>
                    <td><?php switch($vo['status']): case "1": ?>正常<?php break; case "0": ?>禁用<?php break; case "-1": ?>删除<?php break; endswitch; ?>
                    </td>
                    <td><?php switch($vo['is_nav']): case "1": ?>是<?php break; case "0": ?>否<?php break; endswitch; ?>
                    </td>
                    <td><?php echo htmlentities($vo['sort']); ?></td>
                    <td>
                        <button class="btn btn-xs btn-primary" onclick="layer_show('编辑节点','/admin/Auth/rule_edit.html?id=<?php echo htmlentities($vo['id']); ?>',800,600)"><i class="fa fa-edit"></i> 编辑</button>
                        <?php if($vo['status'] == 1): ?>
                        <button class="btn btn-xs btn-default do-del" data-db="auth_rule" data-id="<?php echo htmlentities($vo['id']); ?>" data-status="0"><i class="fa fa-trash-o"></i> 删除</button>
                        <?php else: ?>
                        <button class="btn btn-xs btn-default do-del" data-db="auth_rule" data-id="<?php echo htmlentities($vo['id']); ?>" data-status="1"><i class="fa fa fa-recycle"></i> 恢复</button>
                        <?php endif; if($vo['level'] < 2): ?><button class="btn btn-xs btn-mint" onclick="layer_show('添加节点','/admin/Auth/rule_add.html?id=<?php echo htmlentities($vo['id']); ?>',800,600)"><i class="fa fa-plus"></i> 添加</button><?php endif; ?>
                    </td>
                </tr>
