<?php /*a:2:{s:64:"/home/wwwroot/ytshop/application/admin/view/goods/attr_list.html";i:1523434690;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div id="report-wrapper" class="content clearfix">
    <div class="main-content">
        ...
        <div>
            <button class="btn btn-mint" onclick="layer_show('添加商品规格','/admin/Goods/attr_add.html',1000)"><i class="fa fa-plus"></i> 新增规格</button>
        </div>
            ...
            <table class="table table-bordered" lay-even>
                ...
                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td><?php echo htmlentities($vo['attr_name']); ?></td>
                        <td>
                            <button class="btn btn-xs btn-default do-del" data-db="goodsAttribute" data-id="<?php echo htmlentities($vo['id']); ?>" data-status="-1"><i class="fa fa-trash-o"></i> 删除</button>
                            <a class="btn btn-xs btn-primary" onclick="layer_show('编辑规格','/admin/Goods/attr_edit?id=<?php echo htmlentities($vo['id']); ?>',800,600)"><i class="fa fa-edit"></i> 编辑</a>
                        </td>
                    </tr>
