<?php /*a:2:{s:62:"/home/wwwroot/ytshop/application/admin/view/push/mom_push.html";i:1523434692;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-lg-12">
                ...
                <div class="search-box col-sm-9">
                    <form role="form" class="form-inline" method="get">
                        <div class="input-group">
                            ...
                            <input type="text" name="content" placeholder="请输入相关内容" class="form-control j-data" value="<?php echo htmlentities((isset($_GET['content']) && ($_GET['content'] !== '')?$_GET['content']:'')); ?>">
                        </div>
                        ...
                        <a class="btn btn-primary" href="<?php echo url('Push/mom_push'); ?>" >清空</a>
                    </form>
                </div>
            </div>
            <br>
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr class="gradeX">
                    ...
                    <td class="c-primary" style="max-width: 500px;overflow: hidden; text-overflow: ellipsis;white-space: nowrap;"><?php echo htmlentities($vo['content']); ?></td>
                    <td><?php echo htmlentities(date("Y-m-d H:i:s",!is_numeric($vo['create_time'])? strtotime($vo['create_time']) : $vo['create_time'])); ?></td>
                    <td><?php echo htmlentities($vo['likecount']); ?></td>
                    <td><?php echo htmlentities($vo['sharecount']); ?></td>
                    <td><?php echo htmlentities($vo['commentcount']); ?></td>
                    <td>
                        <a class="btn btn-xs btn-primary" onclick="layer_show('详情','/admin/Push/push_detail?id=<?php echo htmlentities($vo['id']); ?>',1000)"><i class="fa fa-detail"></i> 详情</a>
                        <button class="btn btn-xs btn-default do-del" data-db="mom_push" data-id="<?php echo htmlentities($vo['id']); ?>" data-status="-1"><i class="fa fa-trash-o"></i> 删除</button>
                    </td>
                </tr>
