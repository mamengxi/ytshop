<?php /*a:2:{s:64:"/home/wwwroot/ytshop/application/admin/view/operate/ad_edit.html";i:1523953165;s:62:"/home/wwwroot/ytshop/application/admin/view/public/iframe.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                ...
                <form class="layui-form form-horizontal" action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="ad_name" value="<?php echo htmlentities($info['ad_name']); ?>" lay-verify="required" autocomplete="off" placeholder="请输入标题" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">url<i class="red">*</i></label>
                            <div class="col-sm-10">
                                <input type="text" name="url" value="<?php echo htmlentities($info['url']); ?>" lay-verify="required" autocomplete="off" placeholder="请输入跳转url" class="form-control">
                            </div>
                        </div>
                        <!--<div class="form-group">-->
                            ...
                            <!--<div class="col-sm-10">-->
                                <!--<div class="input-group mar-btm">-->
                                    ...
                                    <!--<input type="text" name="start_time" value="<?php echo htmlentities(date('Y-m-d',!is_numeric($info['start_time'])? strtotime($info['start_time']) : $info['start_time'])); ?>" id="laydate-start" lay-verify="required" autocomplete="off" placeholder="展示开始时间" class="form-control" >-->
                                    <!--<div class="input-group-addon">结束</div>-->
                                    <!--<input type="text" name="end_time" value="<?php echo htmlentities(date('Y-m-d',!is_numeric($info['end_time'])? strtotime($info['end_time']) : $info['end_time'])); ?>" id="laydate-end" lay-verify="required" autocomplete="off" placeholder="展示结束时间" class="form-control" >-->
                                <!--</div>-->
                            <!--</div>-->
                        <!--</div>-->
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="file-list clearfix">
                                    <ul>
                                        <li><img src="<?php echo htmlentities($info['img_src']); ?>"/>
                                           </li>
                                </ul>
                        ...
                        <!--<div class="form-group">-->
                            ...
                            <!--<div class="col-sm-6">-->
                                <!--<input type="text" name="sort" value="<?php echo htmlentities($info['sort']); ?>" lay-verify="required" value="0" autocomplete="off" placeholder="越大越靠前" class="form-control">-->
                            <!--</div>-->
                    ...
                    <input type="hidden" name="location_id" value="<?php echo htmlentities($info['location_id']); ?>">
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-10 col-sm-offset-2">
                                <button class="btn btn-mint" lay-submit="" data-url="<?php echo url('Operate/ad_edit',array('id'=>$info['id'])); ?>" lay-filter="submit">提交</button>
