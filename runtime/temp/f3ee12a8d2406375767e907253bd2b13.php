<?php /*a:2:{s:65:"/home/wwwroot/ytshop/application/admin/view/goods/brand_edit.html";i:1524564703;s:62:"/home/wwwroot/ytshop/application/admin/view/public/iframe.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                ...
                <form class="layui-form form-horizontal" action="">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="id" lay-verify="required" readonly="true" value="<?php echo htmlentities($info['id']); ?>" autocomplete="off" placeholder="请输入品牌编号" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">品牌名称</label>
                            <div class="col-sm-9">
                                <input type="text" name="title" lay-verify="required" value="<?php echo htmlentities($info['title']); ?>" minlength="1" maxlength="10" autocomplete="off" placeholder="请输入品牌名称" class="form-control" >
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-9 col-sm-offset-3">
                                <button class="btn btn-mint" lay-submit="" data-url="/admin/Goods/brand_edit" lay-filter="submit">提交</button>
