<?php /*a:2:{s:59:"/home/wwwroot/ytshop/application/admin/view/lease/term.html";i:1525339196;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="row panel-body">
                        <form class="layui-form form-horizontal col-sm-6" action="">
                            <!--<div class="form-group">-->
                                ...
                                <!--<div class="col-sm-3">-->
                                    <!--<input type="number" name="expenses" lay-verify="required" autocomplete="off" placeholder="请输入固定计费"  class="form-control" value="<?php echo htmlentities((isset($info['expenses']) && ($info['expenses'] !== '')?$info['expenses']:'')); ?>">-->
                                <!--</div>-->
                            <!--</div>-->
                            <div class="form-group">
                                <label class="col-sm-3 control-label">最低天数min</label>
                                <div class="col-sm-3">
                                    <input type="number" name="start_time" lay-verify="required" autocomplete="off" placeholder="请输入最低天数min" class="form-control" value="<?php echo htmlentities((isset($info['start_time']) && ($info['start_time'] !== '')?$info['start_time']:'')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" name="end_time" lay-verify="required" placeholder="请输入截止天数max" autocomplete="off" class="form-control" value="<?php echo htmlentities((isset($info['end_time']) && ($info['end_time'] !== '')?$info['end_time']:'')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="rate" lay-verify="required" placeholder="格式如:0.1" autocomplete="off" class="form-control" value="<?php echo htmlentities((isset($info['rate']) && ($info['rate'] !== '')?$info['rate']:'')); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">计算公式</label>
                                <div class="col-sm-8 control-label" style="color: #999999">
                                    N><?php echo htmlentities($info['end_time']); ?>,租赁费用=（实际租赁天数-max）*租赁费率（F=<?php echo htmlentities($info['expenses']); ?>+（N-<?php echo htmlentities($info['end_time']); ?>）*<?php echo htmlentities($info['rate']); ?>）
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"></label>
                                <div class="col-sm-6 control-label" style="color: #999999">
                                    <?php echo htmlentities($info['start_time']); ?>< N ≤<?php echo htmlentities($info['end_time']); ?>,租赁计费，F=<?php echo htmlentities($info['expenses']); ?>（租赁费用=<?php echo htmlentities($info['expenses']); ?>）
                                </div>
                            </div>
                            <div class="row">
