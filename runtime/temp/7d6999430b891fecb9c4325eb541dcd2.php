<?php /*a:2:{s:60:"/home/wwwroot/ytshop/application/admin/view/order/index.html";i:1525682679;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-sm-12 layui-tab layui-tab-brief">
                    <ul class="layui-tab-title">
                        <li <?php if(input('status',0) == 0): ?> class="layui-this"<?php endif; ?>><a href="<?php echo url('Order/index'); ?>">全部订单</a></li>


                        <li <?php if(input('status',0) == 2): ?> class="layui-this"<?php endif; ?>><a href="<?php echo url('Order/index',array('status'=>2)); ?>">待付款</a></li>


                        <li <?php if(input('status',0) == 3): ?> class="layui-this"<?php endif; ?>><a href="<?php echo url('Order/index',array('status'=>3)); ?>">待发货</a></li>


                        <li <?php if(input('status',0) == 4): ?> class="layui-this"<?php endif; ?>><a href="<?php echo url('Order/index',array('status'=>4)); ?>">待收货</a></li>


                        <li <?php if(input('status',0) == 5): ?> class="layui-this"<?php endif; ?>><a href="<?php echo url('Order/index',array('status'=>5)); ?>">已完成</a></li>


                        <li <?php if(input('status',0) == 6): ?> class="layui-this"<?php endif; ?>><a href="<?php echo url('Order/index',array('status'=>6)); ?>">已取消</a></li>
                    </ul>
                </div>
                <div class="search-box form-group col-sm-12">
                    <form role="form" class="form-inline layui-form" method="get">
                        ...
                        <div class="input-group">
                            <input type="text" name="consignee" placeholder="请输入收货人" class="form-control j-data" value="<?php echo htmlentities((isset($_GET['consignee']) && ($_GET['consignee'] !== '')?$_GET['consignee']:'')); ?>">
                        </div>
                        ...
                        <a class="btn btn-primary" href="<?php echo url('Order/index'); ?>" >清空</a>
                    </form>
                </div>
            </div>
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr class="gradeX">
                    ...
                    <td><?php echo htmlentities($vo['consignee']); ?>:<?php echo htmlentities($vo['mobile']); ?></td>
                    <td><?php echo htmlentities($vo['total_price']/100); ?></td>
                    <td>
                        <?php switch($vo['logistics_name']): case "SF": ?>顺丰<?php break; case "HTKY": ?>百世汇通<?php break; case "ZTO": ?>中通<?php break; case "STO": ?>申通<?php break; case "YTO": ?>圆通<?php break; case "YD": ?>韵达<?php break; case "EMS": ?>EMS<?php break; case "HHTT": ?>天天<?php break; case "DBL": ?>德邦<?php break; case "YZPY": ?>邮政快递<?php break; default: ?> <span style="color: #999999;">暂无物流</span> 
                        <?php endswitch; ?>
                    </td>
                    <td>
                        <?php switch($vo['is_lease']): case "1": ?> <span style="color:#FF0000;">租赁</span>
                        &nbsp;
                        <!--<a class="btn btn-xs btn-info" onclick="layer_show('发票详情','/admin/Order/invoice_info?id=<?php echo htmlentities($vo['id']); ?>',1000)"><i class="fa fa-edit"></i> 发票信息</a>-->
                        <?php break; case "2": ?> <span style="color:#66CC00;">直接购买</span>
                        <?php break; endswitch; ?>
                    </td>
                    <td>
                    ...
                    <td>
                        <a class="btn btn-xs btn-info" onclick="layer_show('订单详情','/admin/Order/order_info?id=<?php echo htmlentities($vo['order_id']); ?>',1000)"><i class="fa fa-detail"></i> 详情</a>
                        <?php switch($vo['order_status']): case "6": ?>
                            <button class="btn btn-xs btn-default do-del" data-db="orders" data-id="<?php echo htmlentities($vo['order_id']); ?>" data-field="deleted" data-index="order_id" data-status="1"><i class="fa fa-trash-o"></i> 删除</button>
                        <?php break; endswitch; ?>
                    </td>
                </tr>
