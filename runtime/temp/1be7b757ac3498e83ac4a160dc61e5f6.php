<?php /*a:2:{s:63:"/home/wwwroot/ytshop/application/admin/view/lease/contract.html";i:1525673593;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="row panel-body">
                        <form class="layui-form form-horizontal col-sm-8" action="">
                            <div class="form-group">
                                <div class="col-sm-9">
                                    <textarea id="editor" name="contract" type="text/plain" style="width:100%;height:300px;"><?php echo htmlentities($info['contract']); ?></textarea>
                                </div>
                            </div>
                            <div class="row">
                ...
                <div class="layui-tab-item">
                    <div class="row panel-body">
                        <form class="layui-form form-horizontal col-sm-8" action="">
                            <div class="form-group">
                                <div class="col-sm-9">
                                    <textarea id="editor2" name="contract_b" type="text/plain" style="width:100%;height:300px;"><?php echo htmlentities($info['contract_b']); ?></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-9 col-sm-offset-3">
