<?php /*a:2:{s:59:"/home/wwwroot/ytshop/application/admin/view/goods/type.html";i:1523434690;s:60:"/home/wwwroot/ytshop/application/admin/view/public/base.html";i:1523434691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                <div class="form-group col-sm-12">
                    <a class="btn btn-sm btn-primary" onclick="layer_show('添加分类','/admin/Goods/type_add',1000)">添加类型</a>
                </div>
            </div>
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr class="gradeX">
                    ...
                    <td>
                        <button class="btn btn-xs btn-default do-del" data-db="goodsType" data-id="<?php echo htmlentities($vo['id']); ?>" data-status="-1"><i class="fa fa-trash-o"></i> 删除</button>
                        <a class="btn btn-xs btn-primary" onclick="layer_show('编辑类型','/admin/Goods/type_edit?id=<?php echo htmlentities($vo['id']); ?>',800,600)"><i class="fa fa-edit"></i> 编辑</a>
                    </td>
                </tr>
